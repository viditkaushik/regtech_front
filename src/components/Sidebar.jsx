...
import { LayoutDashboard, ShieldCheck, FileText, Settings, HelpCircle, ShieldAlert } from 'lucide-react';
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[72px] bg-card border-r border-border/50 flex flex-col items-center py-6 z-50 shadow-2xl">
      <Link to="/map" className="mb-8" title="Global Dashboard">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gold to-orange-500 flex items-center justify-center shadow-[0_0_15px_rgba(251,191,36,0.2)] hover:scale-105 transition-transform">
      ...
      <div className="w-full px-2 mt-auto">
        <button 
          className="w-full aspect-square flex items-center justify-center rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
